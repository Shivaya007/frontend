...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch("https://backend-1-9tp9.onrender.com/api/getlocation", {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://backend-2-2dtz.onrender.com/api/createuser", {
      // credentials: 'include',
